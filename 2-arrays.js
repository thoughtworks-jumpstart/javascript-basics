...
helper.test(addDashes('025486'), '0-254-8-6') // check that your function works as expected
// helper.test(dash('111246777'), '1112-4-6777') // uncomment this and run program. if test passes, uncomment subsequent tests one by one
// helper.test(dash('0021100'), '0-0-2110-0') 
...
// helper.test(mostFrequentItem(['a', 'a', 'b']), 'a')
// helper.test(mostFrequentItem(['a', 'b', 'b', 'b', 'c', 'a', 'b', 'a', 'b']), 'b')
// helper.test(mostFrequentItem(['yes', 'yes', 'no', 'no', 'yes']), 'yes')
...
// helper.test(removeDuplicateItems([1, 1, 'a']), [1, 'a'])
// helper.test(removeDuplicateItems([1, 1, 'a', 'A']), [1, 'a'])
// helper.test(removeDuplicateItems([1, 'a', 'A', 'b', 'B', 2, 2]), [1, 'a', 'b', 2])
...
// helper.test(union([1, 2], [2, 3]), [1, 2, 3])
...
// helper.test(unionSum([1, 2, 3], [1, 2]), 3)
// helper.test(unionSum([1, 2, 3, 4], [2, 3, 4]), 9)
// helper.test(unionSum([2000, 50, 551, 550, 23], [551, 50, 23]), 624)